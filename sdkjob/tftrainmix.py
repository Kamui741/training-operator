...
def main():
    if HOROVOD_ENABLED:
        ...
        print("Using MultiWorkerMirroredStrategy for distributed training")
    ...
    # 构建和编译模型
    with strategy.scope() if not HOROVOD_ENABLED else nullcontext():
        model = build_model()
